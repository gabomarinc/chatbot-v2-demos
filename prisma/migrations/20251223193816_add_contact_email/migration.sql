-- CreateEnum
CREATE TYPE "AppRole" AS ENUM ('USER', 'SUPER_ADMIN');
...
-- CreateEnum
CREATE TYPE "PlanType" AS ENUM ('FRESHIE', 'MONEY_HONEY', 'WOLF_OF_WALLSTREET', 'CUSTOM');
...
-- AddForeignKey
ALTER TABLE "CostTracking" ADD CONSTRAINT "CostTracking_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
